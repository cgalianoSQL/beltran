...
<head>
	...
	<title>Alta Numero Cliente</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div id="colorcito1" class="container" >
			<div class="row" >
				<div class="col col-lg-3" onclick="location.href='crearAltaCliente.php'" style=" margin-top: 3%;margin-left: 21%;margin-bottom: 3%">
					<div class="card" style="width: 18rem;">
						<div class="card-body" style="min-width:286px;max-width: 286px;min-height:330px;max-height: 330px;">
							
							<div class="alert alert-success" role="alert">
						  <h3>Alta Numero Cliente</h3>
						</div>
						</div>
					</div>
				</div>
				<div class="col col-lg-3" onclick="location.href='listaAltaClientes.php'" style="margin-top: 3%;margin-left: 5%;margin-bottom: 3%">
					<div class="card" style="width: 18rem;">
						<div class="card-body"  style="min-width:286px;max-width: 286px;min-height: 330px;max-height: 330px;">
